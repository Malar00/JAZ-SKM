...
--
-- CREATE TABLE carseller.trains (
--    id INT AUTO_INCREMENT NOT NULL,
--    currentStation VARCHAR(255) NOT NULL,
--    goingToGdansk BIT(1) NULL,
--    currentPauseTime INT NULL,
--    CONSTRAINT train_id_pkey PRIMARY KEY (id));
