INSERT INTO compartments (compartment_size, train_id) VALUES (2, 1);
INSERT INTO compartments (compartment_size, train_id) VALUES (4, 2);
...
--INSERT INTO people (first_name, last_name, destination, train_id) VALUES ('Jan', 'Sitarski', 2, 1);
--INSERT INTO people (first_name, last_name, destination, train_id) VALUES ('Jan', 'Sitarski', 2, 1);
--INSERT INTO people (first_name, last_name, destination, train_id) VALUES ('Jan', 'Sitarski', 2, 1);
--INSERT INTO people (first_name, last_name, destination, train_id) VALUES ('Jan', 'Sitarski', 2, 2);
